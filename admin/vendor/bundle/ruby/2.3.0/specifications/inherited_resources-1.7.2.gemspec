# -*- encoding: utf-8 -*-
# stub: inherited_resources 1.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 5.2.x", ">= 3.2"])
      s.add_runtime_dependency(%q<railties>.freeze, ["< 5.2.x", ">= 3.2"])
      s.add_runtime_dependency(%q<has_scope>.freeze, ["~> 0.6"])
    else
      s.add_dependency(%q<responders>.freeze, [">= 0"])
      s.add_dependency(%q<actionpack>.freeze, ["< 5.2.x", ">= 3.2"])
      s.add_dependency(%q<railties>.freeze, ["< 5.2.x", ">= 3.2"])
